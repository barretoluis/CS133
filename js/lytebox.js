...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure Lytebox ***/
		...
		this.theme   			= (typeof lyteboxTheme !== 'black') && /^(black|grey|red|green|blue|gold|orange)$/i.test(lyteboxTheme) ? lyteboxTheme : 'black'; // themes: black (default), grey, red, green, blue, gold, orange
